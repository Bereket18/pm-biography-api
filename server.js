...
const biographyData = {
  ...
  "data": {
    ...
    "biography": {
      ...
      "earlyLife": "Born in the small town of Beshasha, Abiy Ahmed grew up in a modest family with a Muslim father and a Christian Orthodox mother. He joined the armed struggle against the Derg regime as a teenager.",
      "militaryCareer": "Served in the Ethiopian National Defense Force and participated in the peacekeeping mission in Rwanda. He founded the Information Network Security Agency (INSA), Ethiopia's first cyber security agency."
    },
    "education": [
      {
    ...
    "politicalCareer": {
      ...
      "previousParties": ["Ethiopian People's Revolutionary Democratic Front (EPRDF)"],
      "positions": [
        {
    ...
    "achievements": [
      {
        ...
        "year": "2019",
        "description": "Awarded for his efforts to achieve peace and international cooperation, particularly for resolving the border conflict with Eritrea"
      },
      {
      ...
      },
      {
        ...
        "year": "2019",
        "description": "Environmental campaign that planted billions of trees across Ethiopia"
      },
      {
        "title": "Economic Reforms",
        "year": "2018-Present",
        "description": "Opened key sectors to private investment including telecommunications"
      },
      {
        "title": "Women's Empowerment",
        "year": "2018",
        "description": "Appointed Ethiopia's first female president and achieved 50% female cabinet representation"
      }
    ],
    "awards": [
